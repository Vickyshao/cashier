            ...
            return this.each(function () {
                ...
                if(!isPCa()){
                    ...
                    var html = '<div class="month_change"> ' +
                        '<a href="javascript:" class="iconfont icon-back prev"></a> ' +
                        '<a href="javascript:" class="iconfont icon-right-arrow next"></a> ';
                }else{
                ...
                var S = {
                    ...
                    prevMonth: function (event) {
                        if(!this.isPC()){
                            ...
                            /*$(".date_con .prev").on('mousedown',function(event){
                                $(this).addClass('cur');
                            ...
                            $(".date_con .prev").on('click',function(event){
                                S.changeMonth(-1);
                                S.daysDisabled(options.startDate);
                                event.stopPropagation()
                            })
                    ...
                    nextMonth: function (event) {
                        if(!this.isPC()){
                            ...
                            $(".date_con .next").on('click',function(event){
                                $(this).removeClass('cur');
                                S.changeMonth(1);
                                S.daysDisabled(options.startDate);
                                event.stopPropagation()
